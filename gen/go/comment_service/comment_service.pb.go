...
const file_comment_service_proto_rawDesc = "" +
	"\n" +
	"\x15comment_service.proto\x12\n" +
	"comment.v1\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1bgoogle/protobuf/empty.proto\"c\n" +
	"\n" +
	"Attachment\x12\x12\n" +
	...
	"\x05users\x18\x02 \x03(\tR\x05users\"\xa7\x03\n" +
	"\aComment\x12\x0e\n" +
	...
	"\vattachments\x18\x05 \x03(\v2\x16.comment.v1.AttachmentR\vattachments\x12\x1a\n" +
	...
	"\tparent_id\x18\t \x01(\tR\bparentId\x122\n" +
	"\treactions\x18\n" +
	" \x03(\v2\x14.comment.v1.ReactionR\treactions\x12#\n" +
	"\rreplies_count\x18\v \x01(\x05R\frepliesCount\"\xd5\x01\n" +
	"\x14CreateCommentRequest\x12\x17\n" +
	"\atask_id\x18\x01 \x01(\tR\x06taskId\x12\x17\n" +
	"\auser_id\x18\x02 \x01(\tR\x06userId\x12\x18\n" +
	"\acontent\x18\x03 \x01(\tR\acontent\x128\n" +
	"\vattachments\x18\x04 \x03(\v2\x16.comment.v1.AttachmentR\vattachments\x12\x1a\n" +
	...
	"\vattachments\x18\x03 \x03(\v2\x16.comment.v1.AttachmentR\vattachments\x12\x1a\n" +
	...
	"\x17GetTaskCommentsResponse\x12/\n" +
	...
	"\x19GetCommentRepliesResponse\x12-\n" +
	"\areplies\x18\x01 \x03(\v2\x13.comment.v1.CommentR\areplies\x12\x1f\n" +
	"\vtotal_count\x18\x02 \x01(\x05R\n" +
	"totalCount\"b\n" +
	...
	"comment_id\x18\x01 \x01(\tR\tcommentId\x12\x17\n" +
	"\auser_id\x18\x02 \x01(\tR\x06userId\x12\x14\n" +
	"\x05emoji\x18\x03 \x01(\tR\x05emoji2\xf9\x04\n" +
	"\x0eCommentService\x12F\n" +
	"\rCreateComment\x12 .comment.v1.CreateCommentRequest\x1a\x13.comment.v1.Comment\x12@\n" +
	"\n" +
	"GetComment\x12\x1d.comment.v1.GetCommentRequest\x1a\x13.comment.v1.Comment\x12F\n" +
	"\rUpdateComment\x12 .comment.v1.UpdateCommentRequest\x1a\x13.comment.v1.Comment\x12I\n" +
	"\rDeleteComment\x12 .comment.v1.DeleteCommentRequest\x1a\x16.google.protobuf.Empty\x12Z\n" +
	"\x0fGetTaskComments\x12\".comment.v1.GetTaskCommentsRequest\x1a#.comment.v1.GetTaskCommentsResponse\x12`\n" +
	"\x11GetCommentReplies\x12$.comment.v1.GetCommentRepliesRequest\x1a%.comment.v1.GetCommentRepliesResponse\x12B\n" +
	"\vAddReaction\x12\x1e.comment.v1.AddReactionRequest\x1a\x13.comment.v1.Comment\x12H\n" +
	"\x0eRemoveReaction\x12!.comment.v1.RemoveReactionRequest\x1a\x13.comment.v1.CommentB\x1eZ\x1cshiroyama.comment.v1;boardv1b\x06proto3"
